...
<body>
    ...
    <!-- Page Content -->
    <div class="container">
        <form id="form_criar_post" action="/app/action/inserir.php" method="POST">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="post[categoria]">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <button type="button" id="btn_criar_post" class="btn btn-success">Criar post</button>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
